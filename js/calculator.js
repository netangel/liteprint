...
w70707: {name:"Фотобумага, E-Photo Metallic 210г/м²", price:60.00, sides:2, size:"440×310мм", group:"Бумага", comments: "210 гм/м. Бумага для печати цифровых фотоальбомов реалистичного разрешения. Воспроизведение реальной фотопечати. Небликующая поверхность, устойчива к влажности, стиранию и
грязи."},
...
c0001570: {name:"Картон Sirio Pearl Aurium, 300г/м²", price:73.5, sides:2,
size:"464×320мм", group:"Картон", comments: "Чистоцеллюлозный тонированный картон со специальным перламутровым покрытием и односторонним тиснением. Тонирование под золото."},
